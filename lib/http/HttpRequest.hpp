...
class HttpRequest {
    ...
    public:
        HttpRequest(WiFiClient wifiClient, String host, uint16_t port, String uri);
        HttpRequest(WiFiClient wifiClient, String host, uint16_t port, String uri, String headers);
